-- Updates the institution setup function to include a parameter for a favicon URL.

CREATE OR REPLACE FUNCTION public.update_institution_setup(new_name TEXT, new_tagline TEXT, new_logo_url TEXT, new_favicon_url TEXT)
RETURNS void AS $$
DECLARE
